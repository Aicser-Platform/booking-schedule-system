...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create account in your FastAPI backend
      const res = await fetch(`${apiUrl}/api/auth/signup`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include", // IMPORTANT if backend sets auth_token cookie
        body: JSON.stringify({
          email,
          password,
          full_name: fullName,
      ...
      // Optionally read returned user/session info
      // const data = await res.json()
              ...
              <form onSubmit={handleSignup}>
                <div className="flex flex-col gap-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Select
                      value={role}
                      onValueChange={(v) => setRole(v as "customer" | "staff")}
                      disabled={isLoading}
                    >
