                          ...
                          >
                            ...
                            {change.old_start_time && change.new_start_time ? (
                              <p className="mt-1 text-muted-foreground">
                                {formatDateInTimeZone(change.old_start_time, timezone)}{" "}
                                {formatTimeInTimeZone(change.old_start_time, timezone)} ?{" "}
                                {formatDateInTimeZone(change.new_start_time, timezone)}{" "}
                                {formatTimeInTimeZone(change.new_start_time, timezone)}
                              </p>
                            ) : null}
                            {change.reason ? (
                              <p className="mt-1 text-muted-foreground">
